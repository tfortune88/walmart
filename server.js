...
server.route({
    ...
    handler:function(request,h) {
      var itemIds = productMap[encodeURIComponent(request.params.keyword)];
      if (itemIds == null) {
...
//   console.log('shortDesc: ' + aDescription);
  ...
  for (var i = 0; i < strSplit.length; i++) {
    // TODO: clean up word, remove commas, periods, apostrophes and quotes
    ...
    if (itemIds == null) {
        ...
        // TODO: check to see if the id is already in the list before adding
